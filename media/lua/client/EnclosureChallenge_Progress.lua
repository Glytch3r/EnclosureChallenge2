...
function EnclosureChallenge.extendChallenge(pl) -- accepted challenge 2nd time or beyond
end
...
function EnclosureChallenge.winChallenge(isRemote) -- survived till timer 0
   if not isRemote then

      EnclosureChallenge.storeConquered()
