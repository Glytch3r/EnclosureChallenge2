...
function EnclosureChallenge.doTimer()
    local ec = EnclosureChallenge.getData()
    if ec and EnclosureChallenge.isChallenger() then
        EnclosureChallenge.doNotif()
        if EnclosureChallenge.isRemoteMode()  then
            EnclosureChallenge.RemoteTimer()
        elseif EnclosureChallenge.isAdditiveMode() then
            EnclosureChallenge.AdditiveTimer()
        end
    end
end
Events.EveryHours.Add(EnclosureChallenge.doTimer)
...
function EnclosureChallenge.doNotif()    
    local msg = EnclosureChallenge.getTimeStr()
    if SandboxVars.EnclosureChallenge.HourSfx  then
        getSoundManager():playUISound("EnclosureChallenge_Count")
    end
    if SandboxVars.EnclosureChallenge.HourNotif  then
